...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <asp:Button ID="Button2" runat="server" Height="55px" Text="จัดการข้อมูลสถานที่" Width="200px" BackColor="#669999" />
        <asp:Button ID="Button3" runat="server" Height="55px" Text="จัดการข้อมูลลูกค้า" Width="200px" BackColor="#669999" />
        <br />
        <br />
        <br />
        <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="! รายการเช่ารถของลูกค้าทั้งหมด !"></asp:Label>
            <br />
        <br />
