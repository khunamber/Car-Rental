...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><center>
    <br />&nbsp;<asp:Button ID="Button1" runat="server" Height="55px" Text="จัดการข้อมูลรถ" Width="200px" BackColor="Black" OnClick="Button1_Click" ForeColor="White" BorderStyle="Ridge" />
    ...
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="ข้อมูลลูกค้า"></asp:Label>
        <br />
    <br />
